<div id="categories" class="flex flex-col items-center justify-center mb-2 mx-6">
...
<style>
  #categories > div {
	...
	@apply flex flex-col items-center justify-center text-white text-center h-[50vh] md:h-[31vh] w-full bg-cover bg-center transition-all duration-300 my-2 rounded-xl drop-shadow-lg px-2 py-1
  }
  #main {
    background-image:
