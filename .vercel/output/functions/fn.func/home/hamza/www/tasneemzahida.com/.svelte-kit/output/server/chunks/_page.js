import { $ as noop, a0 as ensure_array_like, X as attr, W as escape_html, a1 as bind_props, a2 as clsx, T as pop, Q as push$1, a3 as fallback, Y as stringify$2, a4 as spread_attributes, a5 as copy_payload, a6 as assign_payload } from "./index.js";
import "./client.js";
import fuzzysort from "fuzzysort";
import { h as html$6 } from "./html.js";
...
function Tab($$payload, $$props) {
  ...
  $$payload.out += `<div role="group" class="svelte-8efuk4"><!--[-->`;
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    let tabName = each_array[$$index];
    $$payload.out += `<button${attr("aria-current", currTab === tabName)} class="svelte-8efuk4">${escape_html(tabName)}</button>`;
  }
  $$payload.out += `<!--]--></div>`;
  bind_props($$props, { currTab, form });
}
function Result($$payload, $$props) {
  push$1();
  let { result, onclick, selected } = $$props;
  $$payload.out += `<div${attr("class", clsx({ selected }) + " svelte-19vpxlf")}><button${attr("class", clsx(["outline", { selected }]) + " svelte-19vpxlf")}>`;
  if (!result) {
    $$payload.out += "<!--[-->";
  } else {
    $$payload.out += "<!--[!-->";
    if (Object.hasOwn(result, "content")) {
      $$payload.out += "<!--[-->";
      $$payload.out += `<img${attr("src", new URL(`/src/lib/assets/events/${result.picture}`, import.meta.url).href)}${attr("alt", result.title)} class="svelte-19vpxlf">`;
    } else {
      $$payload.out += "<!--[!-->";
      $$payload.out += `<img${attr("src", new URL(`/src/lib/assets/${result.category}/${result.filename}`, import.meta.url).href)}${attr("alt", result.title)} class="svelte-19vpxlf">`;
    }
    $$payload.out += `<!--]-->`;
  }
  $$payload.out += `<!--]--> <h3>${escape_html(result.title)}</h3></button> `;
  if (selected) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<small>Click again to de-select</small>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div>`;
...
function Search($$payload, $$props) {
  push$1();
  let { items, selected = null, placeholder, form } = $$props;
  let searchQuery = "";
  let results = items[0] ? fuzzysort.go(searchQuery, items, {
    keys: Object.hasOwn(items[0], "content") ? ["title", "description"] : ["title", "description", "date", "content"]
  }).map((r) => r.obj) : [];
  console.log(items);
  $$payload.out += `<label>Select <input type="search" name="search"${attr("placeholder", placeholder)}${attr("aria-label", placeholder)}${attr("value", searchQuery)}${attr("aria-invalid", form ? form.errors?.search ? "true" : "false" : null)} aria-describedby="search-helper"> <small id="search-helper">${escape_html(form?.errors?.search)}</small></label> `;
  if (!selected) {
    $$payload.out += "<!--[-->";
    const each_array = ensure_array_like(results);
    $$payload.out += `<section class="svelte-1vc6djz"><!--[-->`;
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let result = each_array[$$index];
      Result($$payload, { result, onclick: () => selected = result });
    }
    $$payload.out += `<!--]--></section>`;
  } else {
    $$payload.out += "<!--[!-->";
...
function mergeDefaultInterface(partial, def) {
  if (!partial)
    return def;
  const final = { ...def };
  Object.entries(partial).forEach(([key2, value]) => {
    final[key2] = value;
  });
  return final;
}
...
function Renderer$1($$payload, $$props) {
  push$1();
  ...
  $$payload.out += `<div class="carta-renderer markdown-body svelte-1oqga2r"${attr("style", `display: ${stringify$2(hidden ? "none" : "unset")};`)}>${html$6(renderedHtml)} `;
  {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div>`;
  bind_props($$props, { carta, value, elem, hidden });
  pop();
}
function Diff() {
}
...
function Input($$payload, $$props) {
  ...
  $$payload.out += `<div role="tooltip" class="editor-unfocus-suggestion svelte-1pd848b"${attr("id", `editor-unfocus-suggestion-${stringify$2(simpleUUID)}`)}${attr("style", `display: ${stringify$2(hidden ? "none" : "unset")};`)}>Press ESC then TAB to move the focus off the field</div> <div role="textbox" tabindex="-1" class="carta-input svelte-1pd848b"${attr("style", `display: ${stringify$2(hidden ? "none" : "unset")};`)}><div class="carta-input-wrapper svelte-1pd848b"><div class="carta-highlight carta-font-code svelte-1pd848b" tabindex="-1" aria-hidden="true">${html$6(highlighted)}</div> <textarea${spread_attributes(
    {
      class: "carta-font-code",
      "aria-multiline": "true",
      "aria-describedby": `editor-unfocus-suggestion-${stringify$2(simpleUUID)}`,
...
function MenuIcon($$payload) {
  $$payload.out += `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16"><path fill="currentColor" d="M4 8a2 2 0 1 1-3.999.001A2 2 0 0 1 4 8m6 0a2 2 0 1 1-3.999.001A2 2 0 0 1 10 8m6 0a2 2 0 1 1-3.999.001A2 2 0 0 1 16 8"></path></svg>`;
}
function Toolbar($$payload, $$props) {
  ...
  $$payload.out += `<div class="carta-toolbar svelte-14g49jy" role="toolbar"><div class="carta-toolbar-left svelte-14g49jy">`;
  if (mode == "tabs") {
    $$payload.out += "<!--[-->";
    $$payload.out += `<button type="button"${attr("tabindex", 0)}${attr("class", clsx(tab2 === "write" ? "carta-active" : "") + " svelte-14g49jy")}>${escape_html(labels.writeTab)}</button> <button type="button"${attr("tabindex", -1)}${attr("class", clsx(tab2 === "preview" ? "carta-active" : "") + " svelte-14g49jy")}>${escape_html(labels.previewTab)}</button>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div> <div class="carta-filler svelte-14g49jy"></div> <div class="carta-toolbar-right svelte-14g49jy">`;
  if (!(mode === "tabs" && tab2 === "preview")) {
    $$payload.out += "<!--[-->";
    const each_array = ensure_array_like(visibleIcons);
    $$payload.out += `<!--[-->`;
    for (let index2 = 0, $$length = each_array.length; index2 < $$length; index2++) {
      let icon = each_array[index2];
      const label = labels.iconsLabels[icon.id] ?? icon.label;
      $$payload.out += `<button class="carta-icon svelte-14g49jy"${attr("tabindex", index2 == 0 ? 0 : -1)}${attr("title", label)}${attr("aria-label", label)}><!---->`;
      icon.component?.($$payload, {});
      $$payload.out += `<!----></button>`;
    }
    $$payload.out += `<!--]--> `;
    if (iconsHidden) {
      ...
      $$payload.out += `<button class="carta-icon svelte-14g49jy"${attr("tabindex", -1)}${attr("title", label)}${attr("aria-label", label)}>`;
      MenuIcon($$payload);
      $$payload.out += `<!----></button>`;
    } else {
      $$payload.out += "<!--[!-->";
  ...
  $$payload.out += `<!--]-->`;
  bind_props($$props, { carta, mode, tab: tab2, labels });
  pop();
}
function MarkdownEditor($$payload, $$props) {
  push$1();
  let carta = $$props["carta"];
  let theme = fallback($$props["theme"], "default");
  let value = fallback($$props["value"], "");
  let mode = fallback($$props["mode"], "auto");
  let scroll = fallback($$props["scroll"], "sync");
  let disableToolbar = fallback($$props["disableToolbar"], false);
  let placeholder = fallback($$props["placeholder"], "");
  let textarea = fallback($$props["textarea"], () => ({}), true);
  let selectedTab = fallback($$props["selectedTab"], "write");
  let userLabels = fallback($$props["labels"], () => ({}), true);
  ...
  function loadScrollPosition(tab2) {
    if (windowMode !== "tabs") return;
    const elem = tab2 === "write" ? inputElem : rendererElem;
    if (!elem) return;
  ...
  function $$render_inner($$payload2) {
    $$payload2.out += `<div${attr("class", `carta-editor carta-theme__${stringify$2(theme)} svelte-smf7uv`)}>`;
    if (!disableToolbar) {
      $$payload2.out += "<!--[-->";
      Toolbar($$payload2, {
        carta,
    ...
    $$payload2.out += `<!--]--> <div class="carta-wrapper"><div${attr("class", `carta-container mode-${stringify$2(windowMode)} svelte-smf7uv`)}>`;
    Input($$payload2, {
      carta,
      placeholder,
      props: textarea,
...
class Processor extends CallableInstance {
  ...
  data(key2, value) {
    if (typeof key2 === "string") {
      ...
      return own$7.call(this.namespace, key2) && this.namespace[key2] || void 0;
    }
    if (key2) {
      assertUnfrozen("data", this.frozen);
      this.namespace = key2;
...
function zwitch(key2, options) {
  ...
  function one2(value, ...parameters) {
    ...
    if (value && own$4.call(value, key2)) {
      ...
      fn = own$4.call(handlers2, id) ? handlers2[id] : one2.unknown;
    }
    if (fn) {
...
class InputEnhancer {
  ...
  handleKeyDown(e) {
    ...
    if (key2 === "enter") {
    ...
    } else if (key2 == "tab" && !this.escapePressed) {
      e.preventDefault();
      ...
      if (matchedDelimiter) {
        ...
        if (e.shiftKey) {
          ...
          const position2 = this.textarea.selectionStart;
          if (lineContent.startsWith("	")) {
            this.removeAt(lineStart, 1);
            this.textarea.selectionStart = position2 - 1;
            this.textarea.selectionEnd = position2 - 1;
          }
        } else {
          const position2 = this.textarea.selectionStart;
  ...
  handleNewLine(e) {
    ...
    for (const prefix of this.settings.prefixes) {
      ...
      if (match) {
        ...
        const content2 = line.slice(strMatch.length).trim();
        if (content2 === "") {
   ...
   */
  getLine(index2 = this.textarea.selectionStart) {
    let lineStartingIndex, lineEndingIndex;
    for (lineStartingIndex = index2; lineStartingIndex > 0 && this.textarea.value.at(lineStartingIndex - 1) !== "\n"; lineStartingIndex--)
      ;
    for (lineEndingIndex = index2; lineEndingIndex < this.textarea.value.length - 1 && this.textarea.value.at(lineEndingIndex) !== "\n"; lineEndingIndex++)
      ;
    return {
   ...
   */
  insertAt(position2, string2) {
    const value = this.textarea.value;
    this.textarea.value = value.slice(0, position2) + string2 + value.slice(position2);
  }
  /**
   ...
   */
  removeAt(position2, count = 1) {
    const value = this.textarea.value;
    this.textarea.value = value.slice(0, position2) + value.slice(position2 + count);
  }
  /**
   ...
   */
  toggleLinePrefix(prefix, whitespace2 = "attach") {
    const selection = this.getSelection();
    let index2 = selection.start;
    while (index2 > 0 && this.textarea.value.at(index2 - 1) !== "\n")
      index2--;
    let furtherLinesExist = true;
    const startLocation = selection.start;
    let endLocation = selection.end;
    while (furtherLinesExist) {
      const currentPrefix = this.textarea.value.slice(index2, index2 + prefix.length);
      if (currentPrefix === prefix) {
        if (whitespace2 === "attach" && this.textarea.value.at(index2 + prefix.length) === " ") {
          this.removeAt(index2, prefix.length + 1);
          endLocation -= prefix.length + 1;
        } else {
          this.removeAt(index2, prefix.length);
          endLocation -= prefix.length;
        }
      } else {
        if (whitespace2 === "attach") {
          this.insertAt(index2, prefix + " ");
          endLocation += prefix.length + 1;
        } else {
          this.insertAt(index2, prefix);
          endLocation += prefix.length;
      ...
      while (index2 < this.textarea.value.length && this.textarea.value.at(index2) !== "\n")
        index2++;
      if (this.textarea.value.at(index2) == "\n")
        index2++;
      furtherLinesExist = index2 < endLocation;
    }
...
const defaultKeyboardShortcuts = [
  ...
  // Link
  {
    ...
    action: (input) => {
      ...
      const position2 = input.getSelection().end + 1;
      input.insertAt(position2, "(url)");
      input.textarea.setSelectionRange(position2 + 1, position2 + 4);
    }
  },
  // Strikethrough
  {
...
function ListBulletedIcon($$payload) {
...
function ListNumberedIcon($$payload) {
...
function StrikethroughIcon($$payload) {
...
class Carta {
   ...
   * ```
   */
  bindToCaret(element2, portal = document.querySelector("body")) {
    let callback;
    if (this.input)
      callback = this.input.$bindToCaret(element2, { portal, editorElement: this.element }).destroy;
    this.elementsToBind.push({ elem: element2, portal, callback });
    return {
      destroy: () => {
        callback && callback();
        this.elementsToBind = this.elementsToBind.filter((it) => it.elem != element2);
      }
    };
  }
}
function MDEditor($$payload, $$props) {
  push$1();
  ...
  let $$inner_payload;
  function $$render_inner($$payload2) {
    $$payload2.out += `<div class="svelte-1ebag87">`;
    MarkdownEditor($$payload2, {
      carta,
      get value() {
        return content2;
      },
  ...
  assign_payload($$payload, $$inner_payload);
  bind_props($$props, { content: content2 });
  pop();
}
function _page($$payload, $$props) {
  ...
  const Mode = { Painting: "Painting", Event: "Event" };
  const Crud = {
    Add: "Add",
    Update: "Update",
    Remove: "Remove"
  };
  const modeTabNames = Object.values(Mode);
  const crudTabNames = Object.values(Crud);
  let currMode = Mode.Painting;
  let currCrud = Crud.Add;
  let aOrAn = isVowel(currMode[0]) ? "an" : "a";
  ...
  let $$inner_payload;
  function $$render_inner($$payload2) {
    $$payload2.out += `<header class="pico svelte-1jvr96j">`;
    Tab($$payload2, {
      tabNames: modeTabNames,
      get currTab() {
        return currMode;
      },
      set currTab($$value) {
    ...
    $$payload2.out += `<!----></header> <article class="svelte-1jvr96j"><h1 class="svelte-1jvr96j">${escape_html(currCrud)} ${escape_html(aOrAn)} ${escape_html(currMode)}</h1> <form method="POST" enctype="multipart/form-data"${attr("action", `?/${currCrud.toLowerCase()}${currMode}`)}><fieldset class="svelte-1jvr96j"><div class="pico">`;
    ...
    if ([Crud.Add, Crud.Update].includes(currCrud)) {
      $$payload2.out += "<!--[-->";
      $$payload2.out += `<label>Title <input type="text" name="title"${attr("value", selectedPainting?.title ?? selectedEvent?.title ?? "")}${attr("placeholder", `Title of the ${currMode} to ${currCrud}`)}${attr("aria-label", `Title of the ${currMode} to ${currCrud}`)}${attr("aria-invalid", form ? form.errors?.title ? "true" : "false" : null)} aria-describedby="title-helper"> <small id="title-helper">${escape_html(form?.errors?.title)}</small></label> `;
      if (currMode === Mode.Event) {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `<label>Date <input type="date" name="date" aria-label="Date"${attr("aria-invalid", form ? form.errors?.date ? "true" : "false" : null)} aria-describedby="date-helper"${attr("value", currCrud === Crud.Update && selectedEvent ? selectedEvent.date : currCrud === Crud.Add ? (/* @__PURE__ */ new Date()).toJSON().split("T")[0] : "")}> <small id="date-helper">${escape_html(form?.errors?.date)}</small></label>`;
      } else {
        $$payload2.out += "<!--[!-->";
      }
      $$payload2.out += `<!--]-->`;
    ...
    if (currMode === Mode.Painting) {
      ...
      if (currCrud === Crud.Add) {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `<label>Category <select name="category" aria-label="Select painting category..."${attr("aria-invalid", form ? form.errors?.category ? "true" : "false" : null)} aria-describedby="category-helper"><option selected disabled value="">Select painting category...</option><option value="main">Main</option><option value="calligraphy">Calligraphy</option><option value="other">Other Artwork</option></select> <small id="category-helper">${escape_html(form?.errors?.category)}</small></label>`;
      } else {
        $$payload2.out += "<!--[!-->";
        if (currCrud === Crud.Update) {
          $$payload2.out += "<!--[-->";
          $$payload2.out += `<label>Category <select name="category" aria-label="Select painting category..."${attr("aria-invalid", form ? form.errors?.category ? "true" : "false" : null)} aria-describedby="category-helper"><option${attr("selected", !selectedPainting, true)} disabled value="">Select painting category...</option><option${attr("selected", selectedPainting?.category?.toLowerCase() === "main", true)} value="main">Main</option><option${attr("selected", selectedPainting?.category?.toLowerCase() === "calligraphy", true)} value="calligraphy">Calligraphy</option><option${attr("selected", selectedPainting?.category?.toLowerCase() === "other", true)} value="other">Other Artwork</option></select> <small id="category-helper">${escape_html(form?.errors?.category)}</small></label>`;
        } else {
          $$payload2.out += "<!--[!-->";
        }
        $$payload2.out += `<!--]-->`;
    ...
    if ([Crud.Add, Crud.Update].includes(currCrud)) {
      $$payload2.out += "<!--[-->";
      $$payload2.out += `<label id="picture-label">Picture <input type="file" name="picture"${attr("aria-invalid", form ? form.errors?.picture ? "true" : "false" : null)} aria-describedby="picture-helper" accept="image/png, image/jpeg, image/gif, image/tiff, image/bpm, image/x-icon, image/apng, image/avif, image/svg, image/webp"> <small id="picture-helper">${escape_html(form?.errors?.picture)}</small></label> <label>Description <textarea name="description"${attr("placeholder", `Describe your ${currMode}`)}${attr("aria-label", `Describe your ${currMode}`)}${attr("aria-invalid", form ? form.errors?.description ? "true" : "false" : null)} aria-describedby="description-helper" class="svelte-1jvr96j">`;
      const $$body = escape_html(currMode === Mode.Painting ? currCrud === Crud.Update && selectedPainting ? selectedPainting.description : "" : currCrud === Crud.Update && selectedEvent ? selectedEvent.description : "");
      if ($$body) {
        $$payload2.out += `${$$body}`;
      }
      $$payload2.out += `</textarea> <small id="description-helper">${escape_html(form?.errors?.description)}</small></label>`;
    } else {
      $$payload2.out += "<!--[!-->";
    }
    $$payload2.out += `<!--]--></div> `;
    if ([Crud.Add, Crud.Update].includes(currCrud) && currMode === Mode.Event) {
      ...
      $$payload2.out += `<!----> <small style="color: #883935">${escape_html(form?.errors?.content)}</small>`;
    } else {
      $$payload2.out += "<!--[!-->";
    }
    $$payload2.out += `<!--]--></fieldset> <div class="pico"><button name="submit"${attr("aria-invalid", form ? form.errors?.description ? "true" : "false" : null)} aria-describedby="submit-helper" class="svelte-1jvr96j">${escape_html(currCrud)}</button> <small id="submit-helper">${escape_html(form?.errors?.submit)}</small></div></form></article>`;
  }
  do {
    $$settled = true;
    $$inner_payload = copy_payload($$payload);
